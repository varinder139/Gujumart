...
public class MyProfileGetSetSecond {

    String name, mobile, email, pinode, district, full_address, useid, addsid;

    public MyProfileGetSetSecond(String name, String mobile, String email, String pinode, String district, String full_address, String useid, String addsid) {
        this.name = name;
        this.mobile = mobile;
        this.email = email;
        this.pinode = pinode;
