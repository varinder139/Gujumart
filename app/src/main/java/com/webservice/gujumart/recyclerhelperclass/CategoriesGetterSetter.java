...
public class CategoriesGetterSetter {
    ...
    public CategoriesGetterSetter(String image, String title, String shortdes, String mrpprice,
                                  int rsprice, String productid, String skuid, String longdesc,
                                  String variation_selected_itm, int qty, ArrayList<String> variationid) {
        this.image = image;
        this.title = title;
