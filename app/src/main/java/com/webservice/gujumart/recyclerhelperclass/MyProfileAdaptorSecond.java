...
public class MyProfileAdaptorSecond extends RecyclerView.Adapter<MyProfileAdaptorSecond.HolderClass> {

    Context context;
    ArrayList<MyProfileGetSetSecond> profileGetSetArrayList;
    CategoriesClickListenerSecond clickListener;

    public MyProfileAdaptorSecond(Context context, ArrayList<MyProfileGetSetSecond> profileGetSetArrayList,
                                  CategoriesClickListenerSecond clickListener) {
    ...
    @NonNull
    @Override
    public MyProfileAdaptorSecond.HolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.myprofile_cardview_second, parent, false);
        final MyProfileAdaptorSecond.HolderClass holderClass = new MyProfileAdaptorSecond.HolderClass(view);
        return holderClass;
    }

    @Override
    public void onBindViewHolder(@NonNull MyProfileAdaptorSecond.HolderClass holder, int position) {
        MyProfileGetSetSecond currentItem = profileGetSetArrayList.get(position);
    ...
    public class HolderClass extends RecyclerView.ViewHolder {
        ...
        Button update, delete, useAddress;
        ...
        public HolderClass(@NonNull View itemView) {
            ...
            useAddress = itemView.findViewById(R.id.btn_use_address);
            ...
            useAddress.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    clickListener.useAddress(view, getAdapterPosition());
                }
            });
        }
    }
