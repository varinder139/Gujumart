...
import com.webservice.gujumart.recyclerhelperclass.MyProfileAdaptor;
import com.webservice.gujumart.recyclerhelperclass.MyProfileGetSet;
...
public class MyProfile extends AppCompatActivity {
    ...
    MyProfileAdaptor myprofileAdaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //------------ hooks recycler view -----
        myprofileRecycler = (RecyclerView) findViewById(R.id.viewprofile_recycler);
    ...
    public  void setRecyclerView(){
      ...
      //  Toast.makeText(getApplicationContext(), "function called", Toast.LENGTH_SHORT).show();
        ...
        final ArrayList<MyProfileGetSet> myProfileGetSets = new ArrayList<>();
       ...
       // Toast.makeText(getApplicationContext(), url, Toast.LENGTH_LONG).show();
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++){
                               ...
                               // String longdes = produt.getString("long_description");
                                ...
                                myProfileGetSets.add(new MyProfileGetSet(nameUrl, mobileurl, emailurl, pincodeurl, districturl, fulladdressurl, useridurl, addressidurl));
                            }
                            myprofileAdaptor = new MyProfileAdaptor(MyProfile.this, myProfileGetSets, new CategoriesClickListener() {
                                @Override
                                public void onItemClick(View v, int position) {
                                   // Toast.makeText(MyProfile.this, "updated button clicked", Toast.LENGTH_SHORT).show();
                                    MyProfileGetSet clickedItem = myProfileGetSets.get(position);
                                ...
                                public void buttonClick(View v, int position) {
                                    Toast.makeText(MyProfile.this, "Delete button cliked", Toast.LENGTH_SHORT).show();
                                    /*
                            ...
                            Toast.makeText(MyProfile.this, "Please Insert New Address", Toast.LENGTH_LONG).show();
                        }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MyProfile.this, "error ocurred", Toast.LENGTH_SHORT).show();
